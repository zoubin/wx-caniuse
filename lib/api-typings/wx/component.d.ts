...
declare namespace Component {
    ...
    interface Options {
         ...
         * 组件的数据监听器
         *
         * 参见 (https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/observer.html#%E7%9B%91%E5%90%AC%E5%AD%97%E6%AE%B5%E8%AF%AD%E6%B3%95)
         */
        observers?: {
            [dataKey: string]: (this: Component, ...a: any[]) => void;
        };
    }
